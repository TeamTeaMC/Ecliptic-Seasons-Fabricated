...
public final class VoxySeasonalModelRegistry {

    public static final int FIRST_SEASONAL_ID = 0x80000;

    private static final Object2IntOpenHashMap<SeasonalModelKey> KEY_TO_ID =
            new Object2IntOpenHashMap<>();

    private static final Int2ObjectOpenHashMap<SeasonalModelEntry> ID_TO_ENTRY =
    ...
    private VoxySeasonalModelRegistry() {
    }

    public static synchronized int getOrCreate(
            Mapper mapper,
            int originalBlockId,
            Identifier modelIdentifier,
            boolean snowy
    ) {
        SeasonalModelKey key = new SeasonalModelKey(
                originalBlockId,
                modelIdentifier,
                snowy
        );
         ...
         */
        int firstSnowyId =
                VoxyTool.MAX_VOXY_BLOCK_ID
                        - mapper.getBlockStateCount();
