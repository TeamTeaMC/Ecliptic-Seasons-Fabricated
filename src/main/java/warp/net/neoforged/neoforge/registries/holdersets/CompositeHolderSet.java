...
public abstract class CompositeHolderSet<T> implements ICustomHolderSet<T> {
    ...
    public boolean isHomogenous() {
        ...
        SerializationType firstType = ICustomHolderSet.getSerializationType(holderSets.get(0));
        ...
        for (int i = 1; i < size; i++) {
            final SerializationType type = ICustomHolderSet.getSerializationType(holderSets.get(i));
